define(function(require) {
	...
	return elgg.trigger_hook('config', 'ckeditor', null, {
		// toolbar: [['Bold', 'Italic', 'Underline', 'RemoveFormat'], ['Strike', 'NumberedList', 'BulletedList', 'Undo', 'Redo', 'Link', 'Unlink', 'Image', 'Blockquote', 'Paste', 'PasteFromWord', 'Markdown']],
		...
		extraPlugins: 'blockimagepaste,autogrow,markdown',
		defaultLanguage: 'en',
